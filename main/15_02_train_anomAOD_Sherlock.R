...
saveRDS(bayes_opt_params, file.path(path_output_sherlock, sprintf("version%s", model_version), "anomAOD", "model", "aod_bayes_opt_params.rds"))
xgb.save(mod_gb_final, file.path(path_output_sherlock, sprintf("version%s", model_version), "anomAOD", "model", "aod_mod.xgb"))
...
saveRDS(list(variable_importance = var_import, 
        ...
        file.path(path_output_sherlock, sprintf("version%s", model_version), "anomAOD", "model", "AOD_var_importance.rds"))
